...
class App:
    ...
    def build(self):
        ...
        try:
            ...
            pass
        style.configure("Treeview", rowheight=30, font=(FONT_FAMILY, 10), fieldbackground="#ffffff", background="#ffffff", foreground="#24292f", bordercolor="#d0d7de")
        style.map("Treeview", background=[("selected", "#d1fae5")], foreground=[("selected", "#064e3b")])
        style.configure("Treeview.Heading", font=(FONT_FAMILY, 10, "bold"), background="#f3f4f6", foreground="#24292f")
